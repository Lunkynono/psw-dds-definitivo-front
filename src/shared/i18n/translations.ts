...
const exact: Record<string, ExactTranslation> = {
  ...
  'Archivo del proyecto': { es: 'Archivo del proyecto', en: 'Project file' },
  'Adjuntar archivo del proyecto': { es: 'Adjuntar archivo del proyecto', en: 'Attach project file' },
  'Quitar archivo': { es: 'Quitar archivo', en: 'Remove file' },
  'Reemplazar archivo': { es: 'Reemplazar archivo', en: 'Replace file' },
  ...
  'No se pudo leer el archivo del proyecto': {
    ...
    en: 'The project file could not be read',
  },
  ...
  'Resumen IA': { es: 'Resumen IA', en: 'AI summary' },
  'Generar resumen IA': { es: 'Generar resumen IA', en: 'Generate AI summary' },
  'Resúmenes IA generados': { es: 'Resúmenes IA generados', en: 'AI summaries generated' },
  'No se pudieron generar los resúmenes IA': {
    es: 'No se pudieron generar los resúmenes IA',
    en: 'AI summaries could not be generated',
  },
  'Aún no hay resúmenes IA': { es: 'Aún no hay resúmenes IA', en: 'There are no AI summaries yet' },
  'Genera los resúmenes cuando ya existan comentarios de evaluación.': {
    es: 'Genera los resúmenes cuando ya existan comentarios de evaluación.',
    en: 'Generate summaries once evaluation comments exist.',
  },
  'Resume lo que opinan el público y el jurado sobre cada proyecto.': {
    es: 'Resume lo que opinan el público y el jurado sobre cada proyecto.',
    en: 'Summarize what the public and judges think about each project.',
  },
  Fortalezas: { es: 'Fortalezas', en: 'Strengths' },
  Mejoras: { es: 'Mejoras', en: 'Improvements' },
  'comentarios analizados': { es: 'comentarios analizados', en: 'comments analyzed' },
